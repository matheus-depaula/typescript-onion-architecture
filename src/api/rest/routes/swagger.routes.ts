...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/health-check',
            ...
            async function HealthCheckController_healthCheck(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/user/:id',
            ...
            async function UserController_findById(request: any, response: any, next: any) {
            const args = {
